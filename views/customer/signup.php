<div class="row">
        ...
        <div class="col-md-4 dangky">
            <form action="<?php echo PATH.'?controller=customer&action=proccess_signup'; ?>" method="post" onsubmit="return ValidateForm(); ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                        <input type="password" class="form-control" name="pass2" id="pass2" placeholder="Nhập lại mật khẩu"><br>
                        </div>
                    </div>
                    <input type="submit" name="signup" id="" class="btn btn-info" value="Đăng ký ngay"><br><br>
                    
                    <a href="<?php echo PATH.'?controller=customer&action=signin'?>">Bạn đã có tài khoản? Đăng nhập tại đây!</a><br><br>
                </form>
        </div>
